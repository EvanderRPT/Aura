...
class INVENTORYMODULE_API UInv_InventoryComponent : public UActorComponent
{
	GENERATED_BODY()
...
public:
	...
	bool IsMenuOpen() const { return bInventoryOpen; }
...
private:
	...
	TWeakObjectPtr<APlayerController> OwingController;
