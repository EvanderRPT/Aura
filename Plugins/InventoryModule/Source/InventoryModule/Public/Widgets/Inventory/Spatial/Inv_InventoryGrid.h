 ...
 */
UCLASS()
class INVENTORYMODULE_API UInv_InventoryGrid : public UUserWidget
{
	GENERATED_BODY()
...
public:
	...
	void ShowCursor();
	void HideCursor();
	void SetOwningCanvas(UCanvasPanel* NewOwningCanvas);
	void DropItem();
...
private:
	...
	void AddSlottedItemCanvas(const int32 Index, const FInv_GridFragment* GridFragment, UInv_SlottedItem* SlottedItem) const;
	void UpdatedGridSlots(UInv_InventoryItem* NewItem, const int32 Index, bool bStackableItem, const int32 StackAmount);
