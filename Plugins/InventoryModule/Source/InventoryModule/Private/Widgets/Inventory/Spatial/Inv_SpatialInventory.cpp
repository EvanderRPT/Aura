...
void UInv_SpatialInventory::EquippedSlottedItemClicked(UInv_EquippedSlottedItem* EquippedSlottedItem)
{
	...
	// Remove of the equipped slotted item from the equipped grid slot (unbind from the OnEquippedItemClicked delegate)
	RemovedEquippedSlottedItem(EquippedSlottedItem);
	
	// Make a new equipped slotted item (for the item wea held in HoverItem)
...
void UInv_SpatialInventory::OnItemHovered()
{
