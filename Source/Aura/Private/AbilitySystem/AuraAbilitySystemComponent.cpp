...
FGameplayTag UAuraAbilitySystemComponent::GetStatusFormAbilityTag(const FGameplayTag& AbilityTag)
{
...
FGameplayTag UAuraAbilitySystemComponent::GetInputTagFormAbilityTag(const FGameplayTag& AbilityTag)
{
	if (const FGameplayAbilitySpec* Spec = GetSpecFromAbilityTag(AbilityTag))
	{
...
void UAuraAbilitySystemComponent::ClientEffectApplied_Implementation(UAbilitySystemComponent* AbilitySystemComponent,const FGameplayEffectSpec& EffectSpec, FActiveGameplayEffectHandle ActiveGameplayEffect)
{
