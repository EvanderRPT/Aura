...
void FAuraGameplayTags::InitializeNativeGameplayTags()
{
	...
	FName("CombatSocket.Attack.Weapon"), 
	FString("Weapon ")
	);
	GameplayTags.CombatSocket_Attack_RightHand = UGameplayTagsManager::Get().AddNativeGameplayTag(
	FName("CombatSocket.Attack.RightHand"), 
	FString("Right Hand ")
	);
	GameplayTags.CombatSocket_Attack_LeftHand = UGameplayTagsManager::Get().AddNativeGameplayTag(
	FName("CombatSocket.Attack.LeftHand"), 
	FString("Left Hand ")
	);
	GameplayTags.CombatSocket_Attack_Tail = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("CombatSocket.Attack.Tail"), 
		FString("Tail ")
		);
	...
	GameplayTags.GameplayCue_FireBlast = UGameplayTagsManager::Get().AddNativeGameplayTag(
		...
		FString("FireBlast Game play cue")
		);
